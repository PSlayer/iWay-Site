...
<head>
	...
	<meta name="keywords" content="Выделенный IP, защита от DoS-атак" >
	<meta name="description" content="При использовании выделенного IP-адреса вы будете защищены от хакерских DoS-атак, направленных на подрыв работоспособности сервера.">
</head>
                        ...
                        <div class="service__main">
                            ...
                            <section class="service__block block-service">
                                ...
                                <div class="block-service__text">
                                    При использовании выделенного IP-адреса вы будете защищены от хакерских DoS-атак, направленных на подрыв работоспособности сервера. На одном IP-адресе может находиться до трехсот сайтов, а в случае осуществления DoS-атаки в результате бана пострадают все сайты
                                </div>
