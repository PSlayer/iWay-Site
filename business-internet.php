...
<head>
	...
	<meta name="keywords" content="Аренда волокон и каналов связи, опто-волокно" >
	<meta name="description" content="Подключения клиентов производятся на скоростях до 10 Гбит/с. Имеем статус регистратора LIR и выделяет своим клиентам необходимое адресное пространство.">
</head>
                        ...
                        <div class="service__main">
                            ...
                            <section class="service__block block-service">
                                ...
                                <div class="block-service__text">
                                    Подключения клиентов производятся на скоростях до 10 Гбит/с. Имеем статус
                                    регистратора LIR и выделяет своим клиентам необходимое адресное пространство. Сеть
                                    включена
                                    в Московский Internet exchange (MSK-IX), что позволяет обмениваться трафиком
                                    напрямую
                                    с другими участниками подключения, оптимизируя маршруты прохождения трафика
                                    и сокращая время передачи информации
                                </div>
                                <ul class="block-service__list">
                                    <li class="block-service__item">
                                        Доступ в Интернет по волоконно-оптическим линиям связи
                                    </li>
                                    <li class="block-service__item">
                                        Беспроводной доступ в Интернет по радиоканалам
                                    </li>
                                    <li class="block-service__item">
                                        Организация сетей WI-FI и HotSpot
                                    </li>
                                    <li class="block-service__item">
                                        Телематические услуги: электронная почта, WEB хостинг, WWW, FTP
                                    </li>
                                </ul>
