...
<html lang="ru">
<head>
	<title>Подключение Цифрового TV</title>
	<meta charset="UTF-8">
	...
	<meta name="keywords" content="Подключение к Цифровому TV, приставка" >
	<meta name="description" content="Цифровое телевидение - это качественная картинка и звук, архив до 7 дней, огромный выбор телеканалов, онлайн кинотеатры.">
</head>
                       ...
                       <?php include 'aside.php'; ?>
                        <div class="service__main">
                            <h1 class="service__title title2">
                                Подключение <span class="nowrap">Цифрового ТВ</span>
                            </h1>
                            <section class="service__block block-service mb">
                                ...
                                <div class="block-service__text">
                                    Цифровое телевидение - это качественная картинка и звук, архив до 7 дней, огромный
                                    выбор телеканалов, онлайн кинотеатры. Возможность просмотра на телевизоре,
                                    компьютере, планшете, телефоне.
                                    <span class="block">Смотри что хочешь, когда хочешь и где хочешь!</span>
                                </div>
                                <ul class="block-service__list">
                                    <li class="block-service__item">
                                        Высокая четкость и яркость 
                                        <span class="pc">изображения</span>
                                    </li>
                                    <li class="block-service__item">
                                        Возможность перемоток
                                    </li>
                                    <li class="block-service__item">
                                        Архив
                                    </li>
                                    ...
                                    <li class="block-service__item">
                                        Создание списка любимых программ
                                    </li>
                                </ul>
                                <!-- <div class="block-service__button">
                                    <a href="#order" class="btn hvcop _popup-link" data-link="order.html">
                                        <span class="btn__body" data-copy>
                                            Подключить за 199 ₽/мес<span class="pc">яц</span>
                                        </span>
                                    </a>
                                </div> -->
                            </section>
                                    ...
                                    <div class="mbblock">
                                        <div class="rates__buttons swiper" data-slider-mob>
                                            <ul class="swiper-wrapper" data-tabs-titles>
                                                <li class="rates__button swiper-slide _tab-active">
                                                    <a href="" class="btn">
                                            ...
                                            <div class="swiper-wrapper">
                                                <div class="rates__slide swiper-slide fulllink">
                                                    <div class="rates__item">
                                                        ...
                                                        <div class="rates__content">
                                                            <div class="rates__content-main">
                                                                <a href="#order" class="rates__blocks _popup-link"
                                                                    ...
                                                                    <div class="rates__block">
                                                                        <h4 class="rates__block-title">Годовой платеж
                                                                        </h4>
                                                                        <ul class="rates__content-list">
                                                                            <li class="rates__content-list-item">
                                                                                <i class="rates__content-list-icon">
                                                                ...
                                                                <div class="rates__slide-company">
                                                                    <div class="rates__slide-company-image">
                                                                        <img src="img/companies/trikolor.svg"
                                                                            alt="trikolor">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="rates__slide-action">
                                                                ...
                                                                <div
                                                                    class="rates__slide-important _item fulllink__another">
                                                                    <span
                                                                        class="rates__slide-important-icon _item__link">
                                                                        <img src="img/icons/important.svg"
                                                                            alt="important">
                                                                    </span>
