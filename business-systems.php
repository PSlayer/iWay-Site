...
<head>
	...
	<meta name="keywords" content="Инженерные системы, телефония, охранная и пожарная сигнализация, видеодомофон, ЛВС, СКС" >
	<meta name="description" content="Комфортную и безопасную недвижимость в современном мире не возможно представить без телекоммуникационных, охранных и пожарных систем, систем контроля доступа.">
</head>
                        ...
                        <div class="service__main">
                            ...
                            <section class="service__block block-service">
                                <div class="block-service__icon">
                                    <img src="img/icons/system.svg" alt="system">
                                </div>
                                <div class="block-service__text">
                                    Комфортную и безопасную недвижимость в современном мире не возможно представить без
                                    телекоммуникационных, охранных и пожарных систем, систем контроля доступа.
                                    Мы предлагаем проектирование, строительство и обслуживание всех видов систем
                                    по доступным ценам
                                </div>
