...
<head>
	...
	<meta name="keywords" content="Видеонаблюдение, камера, видеорегистратор" >
	<meta name="description" content="Знать чем занят ребенок, куда пропали вещи или выключен ли утюг. Поможет установка системы видеонаблюдения.">
</head>
                        ...
                        <div class="service__main">
                            ...
                            <section class="service__block block-service">
                                ...
                                <div class="block-service__text">
                                    Знать чем занят ребенок, куда пропали вещи или выключен ли утюг. Поможет установка
                                    системы видеонаблюдения. А сэкономить на приобретении дорогостоящих
                                    видеорегистраторов можно подключив систему облачного видеонаблюдения
                                </div>
                                <ul class="block-service__list">
                                    <li class="block-service__item">
                                        Оборудование для видеонаблюдения не входит в указанную стоимость
                                    </li>
                                </ul>
