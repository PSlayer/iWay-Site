...
<html lang="ru">
<head>
	<title>Проектирование и строительство</title>
	<meta charset="UTF-8">
	<meta name="format-detection" content="telephone=no">
	<!-- <style>body{opacity: 0;}</style> -->
	<link rel="stylesheet" href="css/style.min.css?_v=20230704191011">
	<link rel="shortcut icon" href="favicon.ico">
	<!-- <meta name="robots" content="noindex, nofollow"> -->
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
	<meta name="keywords" content="Проектирование и строительство линий связи, строительно-монтажные работа, пусконаладочные работы" >
	<meta name="description" content="Проводим полный спектр проектно-изыскательских, строительно-монтажных, пусконаладочных работ с последующим гарантированным обслуживанием построенных сооружений и линий связи">
</head>
                    ...
                    <div class="service__body">
                       ...
                       <?php include 'aside.php'; ?>
                        <div class="service__main">
                            ...
                            <section class="service__block block-service">
                                <div class="block-service__icon block-service__icon_cstr">
                                    <img src="img/icons/settingb.svg" alt="setting">
                                </div>
                                <div class="block-service__text">
                                    Проводим полный спектр проектно-изыскательских, строительно-монтажных,
                                    пусконаладочных работ с последующим гарантированным обслуживанием построенных
                                    сооружений и линий связи
                                </div>
                                <ul class="block-service__list">
                                    <li class="block-service__item">
                                        Проектирование / строительство телекоммуникационных вводов здания
                                    </li>
                                    <li class="block-service__item">
                                        Работы по выносу сетей связи из зоны строительства
                                    </li>
                                    <li class="block-service__item">
                                        Проектирование / строительство телефонной канализации
                                    </li>
                                    <li class="block-service__item">
                                        Проектирование / строительство волоконно-оптических линий связи
                                    </li>
                                    <li class="block-service__item">
                                        Выдача технических условий на подключение объектов к сетям связи
                                    </li>
                                </ul>
                                <div class="block-service__button">
                                    <a href="#order" class="btn hvcop _popup-link" data-link="order.html">
...
<div class="popup popup_success success-popup">
    ...
    <script src="js/app.min.js?_v=20230704191011"></script>
</body>
